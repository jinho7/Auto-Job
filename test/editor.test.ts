...
test('프로필 편집기: 목록에 항목을 추가하고, 빈 항목은 버린다', async () => {
  ...
  const p = scripted([
    pick('대학교 (0개)'),
    pick('+ 대학교 추가'),
    // 학교명, 본교/분교, 학위, 단과대학, 학과계열, 전공, 전공계열, 전공유형, 주야간, 복수전공, 부전공, 입학, 졸업, 학적, 입학구분,
    // 학점, 만점, 전공학점, 전공만점, 총이수, 전공이수, 석차, 소재지, 논문
    'A대학교', skip, '학사', '', '', '컴퓨터공학', '', skip, skip, '', '', '2019.03', '', '졸업예정', skip, '3.85', '4.5', '', skip, '', '', '', '', '',
    pick('+ 대학교 추가'),
